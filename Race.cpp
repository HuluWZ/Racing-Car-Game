...
void startGame(){
    ...
    renderBitmapString(80.5,95,(void *)GLUT_BITMAP_8_BY_13,buffer);
    //Speed Print
    char buffer1 [50];
    sprintf (buffer1, "SPEED:%dKm/h", FPS);
    glColor3f(0.000, 1.000, 0.000);
    renderBitmapString(80.5,95-2,(void *)GLUT_BITMAP_8_BY_13,buffer1);
    //level Print
    if(score % 50 == 0){
        int last = score /50;
        if(last!=level){
    ...
    glColor3f(0.000, 1.000, 0.000);
    renderBitmapString(80.5,95-4,(void *)GLUT_BITMAP_8_BY_13,level_buffer);
...
void fristDesign(){
      ...
      //Text Information in Frist Page
        if(gv==1){
            ...
            renderBitmapString(35,60+10,(void *)GLUT_BITMAP_TIMES_ROMAN_24,"GAME OVER");
            glColor3f(1.000, 0.000, 0.000);
            char buffer2 [50];
            sprintf (buffer2, "Your Score is : %d", score);
            renderBitmapString(33,60-4+10,GLUT_BITMAP_TIMES_ROMAN_24,buffer2);

        }

        glColor3f(1.000, 1.000, 0.000);
        		
        renderBitmapString(40,97,GLUT_BITMAP_8_BY_13,"Hulunlante Worku    0560/11 ");
        renderBitmapString(40,94,GLUT_BITMAP_8_BY_13,"Henok Wondu         0545/11 ");
        renderBitmapString(40,91,GLUT_BITMAP_8_BY_13,"Gashaw Kidanu       0451/11 ");
        renderBitmapString(40,88,GLUT_BITMAP_8_BY_13,"Hunda Guluma        0561/11 ");
        renderBitmapString(40,85,GLUT_BITMAP_8_BY_13,"Eyosias Sahlu       0404/11 ");
        renderBitmapString(40,82,GLUT_BITMAP_8_BY_13,"Habtamu Kiflu       0491/11 ");        

        glColor3f(0.000, 1.000, 0.000);
        renderBitmapString(30,50+10,GLUT_BITMAP_HELVETICA_18,"Press ENTER to START");
        renderBitmapString(30,50-3+10,GLUT_BITMAP_HELVETICA_18,"Press ESC to Exit");

        glColor3f(1.000, 1.000, 1.000);
        renderBitmapString(30,50-6+10,GLUT_BITMAP_8_BY_13,"Press UP to Increase Speed");
        renderBitmapString(30,50-8+10,GLUT_BITMAP_8_BY_13,"Press DOWN to Decrease Speed");
        renderBitmapString(30,50-10+10,GLUT_BITMAP_8_BY_13,"Press RIGHT to Turn Right");
        renderBitmapString(30,50-12+10,GLUT_BITMAP_8_BY_13,"Press LEFT to Turn Left");

		glColor3f(0.000, 1.000, 1.000);
        renderBitmapString(30-5,50-40,GLUT_BITMAP_8_BY_13,"Computer Graphics Lab Project");
        renderBitmapString(30-5,50-43,GLUT_BITMAP_8_BY_13,"Group 3");
